...
from manim import VGroup, MathTex, DecimalNumber
from manim import SurroundingRectangle, Dot, Line, Polygon
from manim import ORANGE, GREEN, WHITE
from manim import DOWN, UP, LEFT, RIGHT, UL, UR, DR, ORIGIN
from manim import DEFAULT_DOT_RADIUS, PI
from manim import always_redraw, linear
from manim import Create, Uncreate, Write, FadeIn, FadeOut, ReplacementTransform
import numpy as np
from .text import problem
...
class Problem12525(MovingCameraScene):
    def construct(self):
        ...
        length_small_line = always_redraw(lambda: 
                DecimalNumber(np.sqrt(sum((small_line.get_start() - small_line.get_end())**2))/2, 1, font_size=25)
