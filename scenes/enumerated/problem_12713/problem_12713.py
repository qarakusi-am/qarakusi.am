...
class Problem12713(FormulaModificationsScene):
    def construct(self):
        ...
        self.formulas = formulas = VGroup(
            Tex(
                '$($', '$3$', '$x$', ' $-$ ', '$y$', '$)$', '$^2$',
                font_size=FONT_SIZE
            ).next_to(2 * UP + 6.5 * LEFT, buff=0.2),  # (3x-y)^2
            Tex(
                '$($', '$5$', '$x$', '$y$', ' $-$ ', '$2$', '$y$', '$)$', '$^2$',
                font_size=FONT_SIZE
            ).next_to(1 * UP + 6.5 * LEFT, buff=0.2),  # (5xy-2y)^2
            Tex(
                '$($', '$x$', '$^3$', ' $-$ ', '$3$', '$y$', '$)$', '$^2$',
                font_size=FONT_SIZE
            ).next_to(6.5 * LEFT, buff=0.2), # (x^3-3y)^2
            Tex(
                '$($', '$c$', '$^3$', '$d$', ' $-$ ', '$2$', '$c$', '$x$', '$)$', '$^2$',
                font_size=FONT_SIZE
            ).next_to(DOWN + 6.5 * LEFT, buff=0.2))  # (c^3d-2cx)^2
        self.numbers = numbers = VGroup(
            *[MathTex(f'{i + 1}. ', font_size=FONT_SIZE - 7).next_to(formulas[i], LEFT, buff=0.3) for i in range(4)]
        )
        numbers.align_to(taskNumber, LEFT)
    ...
    def first(self):
        ...
        self.equality1 = equality1 = difference_square_prop.copy().next_to(formulas[0], 2 * DOWN)
        equality1.align_to(formulas[0],LEFT)
        ...
        self.play(ModifyFormula(equality1, replace_items=[[1]], replace_items_strs=[['$3x$']]))
        self.wait()
        ...
        self.wait(0.5)
        self.play(ModifyFormula(equality1, replace_items=[[3]], replace_items_strs=[['$y$']]))
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality1,
                replace_items=[[7]], replace_items_strs=[['$($', '$3$', '$x$', '$)$']], replace_items_colors=[[RED, RED, RED, RED]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality1,
                replace_items=[[14]], replace_items_strs=[[r'$\cdot$', '$3$', '$x$']], replace_items_colors=[[WHITE, RED, RED]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality1,
                replace_items=[[20]], replace_items_strs=[['$y$']], replace_items_colors=[[BLUE]]
            )
        )
        self.wait(2)
    ...
    def second(self):
        ...
        self.wait(0.5)
        self.fix_formula(equality2)
        self.play(ModifyFormula(equality2, replace_items=[[1]], replace_items_strs=[['$5xy$']]))
        self.wait()
        ...
        self.wait(0.5)
        self.fix_formula(equality2)
        self.play(ModifyFormula(equality2, replace_items=[[3]], replace_items_strs=[['$2y$']]))
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality2,
                replace_items=[[7]], replace_items_strs=[['$($', '$5$', '$x$', '$y$', '$)$']], replace_items_colors=[[RED, RED, RED, RED, RED]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality2,
                replace_items=[[15]], replace_items_strs=[[r'$\cdot$', '$5$', '$x$', '$y$']], replace_items_colors=[[WHITE, RED, RED, RED]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality2, replace_items=[[19]],
                replace_items_strs=[[r'$\cdot$', '$2$', '$y$']], replace_items_colors=[[WHITE, BLUE, BLUE]]
            )
        )
        ...
        self.play(
            ModifyFormula(
                equality2,
                replace_items=[[23]], replace_items_strs=[['$($', '$2$', '$y$', '$)$']], replace_items_colors=[[BLUE, BLUE, BLUE, BLUE]]
            )
        )
        ...
        self.play(
            ModifyFormula(
                equality2,
                remove_items=[7, 11],
                add_after_items=[8, 9], add_items_strs=[['$^2$'], ['$^2$']], add_items_colors=[[WHITE], [WHITE]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality2,
                replace_items=[[7, 8]], replace_items_strs=[['$2$', '$5$']]
            )
        )
        self.wait()
    ...
    def third(self):
        ...
        self.wait(0.5)
        self.fix_formula(equality3)
        self.play(ModifyFormula(equality3, replace_items=[[1]], replace_items_strs=[['$x^3$']]))
        self.wait()
        ...
        self.wait(0.5)
        self.fix_formula(equality3)
        self.play(ModifyFormula(equality3, replace_items=[[3]], replace_items_strs=[['$3y$']]))
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality3,
                replace_items=[[7]], replace_items_strs=[['$($', '$x$', '$^3$', '$)$']], replace_items_colors=[[RED, RED, RED, RED]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality3,
                replace_items=[[14]], replace_items_strs=[[r'$\cdot$', '$x$', '$^3$']], replace_items_colors=[[WHITE, RED, RED]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality3,
                replace_items=[[17]], replace_items_strs=[[r'$\cdot$', '$3$', '$y$']], replace_items_colors=[[WHITE, BLUE, BLUE]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality3,
                replace_items=[[21]], replace_items_strs=[['$($', '$3$', '$y$', '$)$']], replace_items_colors=[[BLUE, BLUE, BLUE, BLUE]]
            )
        )
        self.wait()
        ...
        self.wait()
        self.play(ModifyFormula(power_of_power_prop1, replace_items=[[2], [7]], replace_items_strs=[['$^3$'], ['$^3$']]))
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality3,
                remove_items=[15, 18],
                add_after_items=[16], add_items_strs=[['$^2$']], add_items_colors=[[WHITE]]
            )
        )
        self.wait()
    ...
    def fourth(self):
        ...
        self.play(ModifyFormula(equality4, replace_items=[[1]], replace_items_strs=[['$c^3d$']]))
        self.wait()
        ...
        self.wait(0.5)
        self.fix_formula(equality4)
        self.play(ModifyFormula(equality4, replace_items=[[3]], replace_items_strs=[['$2cx$']]))
        self.wait(2)
        ...
        self.play(
            ModifyFormula(
                equality4,
                replace_items=[[7]], replace_items_strs=[['$($', '$c$', '$^3$', '$d$', '$)$']],
        ...
        self.play(
            ModifyFormula(
                equality4,
                replace_items=[[15]], replace_items_strs=[[r'$\cdot$', '$c$', '$^3$', '$d$']],
        ...
        self.play(
            ModifyFormula(
                equality4,
                replace_items=[[19]], replace_items_strs=[[r'$\cdot$', '$2$', '$c$', '$x$']],
        ...
        self.play(
            ModifyFormula(
                equality4,
                replace_items=[[24]], replace_items_strs=[['$($', '$2$', '$c$', '$x$', '$)$']],
        ...
        self.play(
            ModifyFormula(
                equality4,
                remove_items=[11],
                add_after_items=[9], add_items_strs=[['$)$', '$^2$']], add_items_colors=[[RED, WHITE]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality4,
                remove_items=[7, 10],
                add_after_items=[9], add_items_strs=[['$^\cdot$']], add_items_colors=[[WHITE]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality4,
                replace_items=[[8, 9, 10]], replace_items_strs=[['$^6$']], replace_items_colors=[[RED]]
            )
        )
        self.wait()

        self.rearrange_formula(
            equality4, new_sequence=[*range(13), 17, 18, 13, 14, 15, 16, *range(19, 28)], move_down=[17, 18]
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality4,
                remove_items=[18, 22],
                add_after_items=[19, 20], add_items_strs=[['$^2$'], ['$^2$']], add_items_colors=[[WHITE], [WHITE]]
            )
        )
        self.wait()

        self.play(ModifyFormula(equality4, replace_items=[[18, 19]], replace_items_strs=[['$4$']]))
        self.wait()
