from manim import Write, FadeIn, FadeOut, AnimationGroup, TransformFromCopy, CounterclockwiseTransform
from manim import Tex, MathTex, VGroup, SurroundingRectangle
...
class Problem12703(FormulaModificationsScene):
    ...
    def first(self):
        ...
        self.play(equality1[7:16].animate.set_color(GREY), run_time=0.5)
        self.wait(0.5)

        formulas[0][1:3].set_color(RED)
        self.play(formulas[0][1:3].animate(rate_func=there_and_back, run_time=0.75).scale(1.5))
        self.wait(0.25)

        equality1[1].set_color(RED)
        self.play(equality1[1].animate(rate_func=there_and_back, run_time=0.75).scale(1.5))
        self.wait(0.25)

        self.fix_formula(equality1)
        self.play(ModifyFormula(equality1, replace_items=[[1]], replace_items_strs=[['$2x$']], replace_items_colors=[[RED]]))
        self.wait(0.5)
        ...
        self.play(ModifyFormula(equality1, replace_items=[[3]], replace_items_strs=[['$y$']], replace_items_colors=[[BLUE]]))
        self.wait()

        self.play(equality1[7:9].animate.set_color(WHITE))
        self.wait(0.1)
        self.play(
            ModifyFormula(
                equality1,
                replace_items=[[7]], replace_items_strs=[['$($','$2$','$x$','$)$']], replace_items_colors=[[RED,RED,RED,RED]]
            )
        )
        self.wait()

        self.play(equality1[12:15].animate.set_color(WHITE))
        self.wait(0.1)
        self.play(
            ModifyFormula(
            equality1,
            replace_items=[[14]], replace_items_strs=[[r'$\cdot$', '$2$', '$x$']], replace_items_colors=[[WHITE,RED,RED]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality1,
                replace_items=[[17]],  replace_items_strs=[[r'$\cdot$', '$y$']], replace_items_colors=[[WHITE,BLUE]]
            )
        )
        self.wait()

        self.play(equality1[19:].animate.set_color(WHITE))
        self.wait(0.1)
        ...
        self.play(
            equality1[6:].animate.next_to(formulas[0], RIGHT).set_color(WHITE),
    ...
    def second(self):
        ...
        self.wait(0.5)
        self.play(ModifyFormula(equality2, replace_items=[[1]], replace_items_strs=[['$2m$']]), run_time=0.75)
        self.wait(0.5)
        ...
        self.wait(0.5)
        self.play(ModifyFormula(equality2, replace_items=[[3]], replace_items_strs=[['$3n$']]), run_time=0.75)
        self.wait(0.5)
        ...
        self.play(
            ModifyFormula(
                equality2,
                replace_items=[[7]], replace_items_strs=[['$($', '$2$', '$m$', '$)$']], replace_items_colors=[[RED,RED,RED,RED]]
            )
        )
        self.wait(0)
        ...
        self.play(
            ModifyFormula(
                equality2,
                replace_items=[[14]], replace_items_strs=[[r'$\cdot$', '$2$', '$m$']], replace_items_colors=[[WHITE,RED,RED]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality2, replace_items=[[17]],
                replace_items_strs=[[r'$\cdot$', '$3$','$n$']],replace_items_colors=[[WHITE,BLUE,BLUE]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality2,
                replace_items=[[21]], replace_items_strs=[['$($', '$3$', '$n$', '$)$']],replace_items_colors=[ [BLUE,BLUE,BLUE,BLUE]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality2,
                remove_items=[7, 10],
                add_after_items=[8], add_items_strs=[['$^2$']]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality2,
                replace_items=[[7, 8]], replace_items_strs=[['$4$']]
            )
        )
        self.wait()

        self.rearrange_formula(equality2, new_sequence=[*range(14), 15, 16, 14,*range(17,24)], move_down=[15, 16])
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality2,
                remove_items=[15, 18],
                add_after_items=[16], add_items_strs=[['$^2$']]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality2,
                replace_items=[[15, 16]], replace_items_strs=[['$9$']]
            )
        )
        self.wait()

        self.play(
            equality2[6:].animate.next_to(formulas[1], RIGHT).set_color(WHITE),
    ...
    def third(self):
        ...
        self.wait(0.5)
        self.play(ModifyFormula(equality3, replace_items=[[1]], replace_items_strs=[['$x^5$']]), run_time=0.75)
        self.wait(0.5)
        ...
        self.wait(0.5)
        self.play(ModifyFormula(equality3, replace_items=[[3]], replace_items_strs=[['$4y$']]), run_time=0.75)
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality3,
                replace_items=[[7]], replace_items_strs=[['$($', '$x$', '$^5$', '$)$']],replace_items_colors=[[RED, RED, RED, RED]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality3,
                replace_items=[[14]], replace_items_strs=[[r'$\cdot$', '$x$', '$^5$']],replace_items_colors=[[WHITE, RED, RED]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality3,
                replace_items=[[17]], replace_items_strs=[[r'$\cdot$', '$4$', '$y$']],replace_items_colors=[[WHITE, BLUE, BLUE]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality3,
                replace_items=[[21]], replace_items_strs=[['$($', '$4$', '$y$', '$)$']],replace_items_colors=[[BLUE, BLUE, BLUE, BLUE]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
            equality3,
            replace_items=[[16, 17]], replace_items_strs=[['$16$']])
        )
        self.wait()


        self.play(
            equality3[6:].animate.next_to(formulas[2], RIGHT).set_color(WHITE),
    ...
    def fourth(self):
        ...
        self.play(ModifyFormula(equality4, replace_items=[[1]], replace_items_strs=[['$2a^2$']]))
        self.wait(0.5)
        ...
        self.wait(0.5)
        self.play(ModifyFormula(equality4, replace_items=[[3]], replace_items_strs=[['$3ac$']]))
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality4,
                replace_items=[[7]], replace_items_strs=[['$($', '$2$','$a$', '$^2$', '$)$']], replace_items_colors=[[RED, RED, RED, RED, RED]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality4,
                replace_items=[[15]], replace_items_strs=[[r'$\cdot$', '$2$', '$a$','$^2$']], replace_items_colors=[[WHITE, RED, RED, RED]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality4,
                replace_items=[[19]], replace_items_strs=[[r'$\cdot$', '$3$', '$a$','$c$']], replace_items_colors=[[WHITE, BLUE, BLUE, BLUE]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality4,
                replace_items=[[24]], replace_items_strs=[['$($', '$3$', '$a$','$c$', '$)$']], replace_items_colors=[[BLUE, BLUE, BLUE, BLUE, BLUE]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality4,
                remove_items=[7],
                add_after_items=[8], add_items_strs=[['$^2$', '$($']], add_items_colors=[[WHITE, RED]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality4,
                remove_items=[9, 12],
                add_after_items=[11], add_items_strs=[['$^{\cdot}$']], add_items_colors=[[WHITE]],
                replace_items=[[7, 8]], replace_items_strs=[['$4$']]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality4,
                replace_items=[[9, 10, 11]], replace_items_strs=[['$^4$']]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality4,
                remove_items=[17, 21],
                add_after_items=[18, 19], add_items_strs=[['$^2$'], ['$^2$']], add_items_colors=[[WHITE], [WHITE]]
            )
        )
        self.wait()
        ...
        self.play(
            ModifyFormula(
                equality4,
                replace_items=[[17, 18]], replace_items_strs=[['$9$']]
            )
        )
        self.wait()

        self.play(
            equality4[6:].animate.next_to(formulas[3], RIGHT).set_color(WHITE),
