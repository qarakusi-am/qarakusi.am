...
class Problem11273(Scene):
    def construct(self):
        ...
        example1_height_label = MathTex(r"2\text{"+cm+"}").next_to(example1, LEFT)
        example1_width_label = MathTex(r"10\text{"+cm+"}").next_to(example1, UP)
        example2_height_label = MathTex(r"1\text{"+cm+"}").next_to(example2, LEFT)
        example2_width_label = MathTex(r"11\text{"+cm+"}").next_to(example2, UP)
        perimeter1 = MathTex(r"P=24\text{"+cm+"}").move_to(rectangle1.get_center())
        perimeter2 = MathTex(r"P=12\text{"+cm+"}")
        perimeter3 = MathTex(r"P=18\text{"+cm+"}")
        example1_perimeter = MathTex(r"2+10+2+10=24\text{"+cm+"}").to_edge(DOWN, buff=2).to_edge(LEFT)
        example2_perimeter = MathTex(r"1+11+1+11=24\text{"+cm+"}").to_edge(DOWN, buff=2).to_edge(LEFT)
        example1_area = MathTex(r"S=20\text{"+cm+"}^2").move_to(rectangle1.get_center()).scale(1.2)
        example2_area = MathTex(r"S=11\text{"+cm+"}^2").move_to(rectangle1.get_center()).scale(.85)
        ...
        sum_of_2_perimeters = MathTex(r"12+18=30\text{"+cm+"}").to_edge(LEFT).to_edge(DOWN, buff=1.9)
        nvazox_mas = MathTex(r"30-24=6\text{"+cm+"}").next_to(sum_of_2_perimeters, DOWN).align_to(sum_of_2_perimeters, LEFT)
        ...
        self.wait()
        height = MathTex(r"3\text{"+cm+"}").next_to(rectangle1, LEFT)
        width = MathTex(r"9\text{"+cm+"}").next_to(rectangle1, UP)
        ...
        self.play(
            Write(MathTex(r"S=3\cdot9=27\text{"+cm+"}^2").move_to(rectangle1.get_center()).shift(DOWN*.27)),
            run_time=4
        )
        self.wait(2)
