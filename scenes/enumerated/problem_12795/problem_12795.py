from manim import LEFT, UP, DOWN, RIGHT, BLUE
from manim import FadeOut, Write, FadeIn
from manim import AnimationGroup, Group, VGroup, ReplacementTransform, Wiggle
from manim import Line, Rectangle, Arrow, MathTex, Circle, Dot, Arc, PI, Intersection, ArcBetweenPoints, Exclusion
from manim import UL, DR, UR, DL
from manim import RED, PURE_GREEN, ORANGE, YELLOW, WHITE

from qarakusiscene import QarakusiScene
from . import text


class Problem12795(QarakusiScene):
    ...
    def construct(self):
        ...
        condition_1_down_shift = 1.5 * DOWN
        ...
        self.play(condition_1_1_copy.animate.shift(condition_1_down_shift))
        ...
        self.play(condition_1_3_copy.animate.shift(condition_1_down_shift))
        ...
        self.play(condition_1_5_copy.animate.shift(condition_1_down_shift))
        ...
        self.play(condition_1_7_copy.animate.shift(condition_1_down_shift),
                  condition_1_9_copy.animate.shift(condition_1_down_shift),
                  condition_1_11_copy.animate.shift(condition_1_down_shift))
        ...
        transform_6 = MathTex(text.TRANSFORM_6, color=ORANGE).move_to(condition_1_11_copy)
        ...
        self.play(condition_1_2_copy.animate.shift(condition_1_down_shift))
        ...
        self.play(condition_1_8_copy.animate.shift(condition_1_down_shift))
        ...
        condition_1_11_copy = condition_1[11].copy()
        self.play(condition_1_11_copy.animate.shift(condition_1_down_shift))
        transform_10 = MathTex(text.TRANSFORM_10, color=PURE_GREEN).move_to(condition_1_11_copy)
        self.play(ReplacementTransform(condition_1_11_copy, transform_10))
        self.wait()

        multipoint_2 = MathTex(text.MULTIPOINT, color=PURE_GREEN).next_to(condition_1_11_copy, aligned_edge=DOWN, buff=0.5)
        ...
        arc_1 = Arc(start_angle=PI / 100 * 173.5, angle=PI / 1.89, radius=1.5, color=PURE_GREEN).shift(2.2 * DOWN)
        arc_2 = Arc(start_angle=-PI / 100 * 73.5, angle=-PI / 1.89, radius=1.5, color=ORANGE).shift(2.2 * DOWN)
        ...
        self.play(Group(circle_1, num_33_copy, arc_1, condition_2_1_copy_1).animate.shift(LEFT + 1.5 * UP),
                  ...
                  FadeOut(Group(arrow_1, arrow_2, arrow_3, arrow_4)))
        self.wait()

        # -------------------------- Point 13 ------------------------------- #
        # diff = Exclusion(circle_1, circle_2, color=ORANGE, fill_opacity=0.5)
