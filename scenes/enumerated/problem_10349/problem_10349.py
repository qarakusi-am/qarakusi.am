...
class Problem10349(Scene):
    def construct(self):
        ...
        souren_car = SimpleSVGMobject('car_1').scale(0.3).align_to(souren_road, UL).shift(UP * 0.5)
        arshak_car = SimpleSVGMobject('car_2').scale(0.3).align_to(arshak_road, UR).shift(UP * 0.5).flip()
        self.play(FadeIn(souren_car), FadeIn(arshak_car))
        souren_car_move = souren_car.animate(rate_func=linear, run_time=5).align_to(souren_road, UR).shift(
            UP * 0.5 + LEFT * 0.1)
        arshak_car_move = arshak_car.animate(rate_func=linear, run_time=3).align_to(arshak_road, UL).shift(
            UP * 0.5 + RIGHT * 0.1)
        self.play(AnimationGroup(souren_car_move, arshak_car_move, road_length.animate.shift(UP * 0.5), lag_ratio=0.4))
        self.wait()
        self.play(
            AnimationGroup(
                VGroup(
                    road, road_length, souren_road, arshak_road, souren_car, arshak_car, meeting_t
                       ).animate.to_edge(DOWN, buff=0.5),
                FadeOut(city),
                lag_ratio=0.2
            )
        )
        ...
        # պայմաններ ###############################################################################
        condition1 = Tex(*condition1_string).scale(.5).to_edge(UP, buff=3.2)
        condition2 = Tex(*condition2_string).scale(.5)
        condition2.next_to(condition1, DOWN, buff=0.3).align_to(condition1, LEFT)
        condition3 = Tex(*condition3_string).scale(.5)
        condition3.next_to(condition2, DOWN, buff=0.3).align_to(condition2, LEFT)
        condition4 = Tex(*condition4_string).scale(.5)
        condition4.next_to(condition3, DOWN, buff=0.3).align_to(condition3, LEFT)
        condition1_check = SimpleSVGMobject('check').scale(0.1).align_to(condition1, UL).shift(LEFT*0.3)
        condition2_check = SimpleSVGMobject('check').scale(0.1).align_to(condition2, UL).shift(LEFT*0.3)
        condition3_check = SimpleSVGMobject('check').scale(0.1).align_to(condition3, UL).shift(LEFT*0.3)
        condition4_check = SimpleSVGMobject('check').scale(0.1).align_to(condition4, UL).shift(LEFT*0.3)
        condition1[0].set_color(ORANGE)
        condition2[0].set_color(ORANGE)
        condition3[0].set_color(ORANGE)
        condition4[0].set_color(ORANGE)
        # ##########################################################################################

        self.play(FadeOut(souren_car), FadeOut(arshak_car), Write(condition1))
        self.play(Write(condition1_check))
        self.wait()
        ...
        self.play(Write(condition2), Indicate(souren_t))
        self.play(Write(condition2_check))
        self.wait()
        self.play(Indicate(meeting_t))
        self.wait()
        ...
        self.play(Write(condition3), Indicate(arshak_t))
        self.play(Write(condition3_check))
        self.wait()
        self.play(Indicate(meeting_t))
        self.wait()
        ...
        self.play(Write(condition4), Indicate(road_length))
        self.play(Write(condition4_check))
        self.wait(2)
        ...
        self.play(AnimationGroup(
            FadeOut(condition1_check), FadeOut(condition1),
            FadeOut(condition2_check), FadeOut(condition2),
            FadeOut(condition3_check), FadeOut(condition3),
            FadeOut(condition4_check), FadeOut(condition4),
            lag_ratio=0.3
        ))

        road_new = VGroup(*[x5_one_part[i] for i in range(5)], *[x3_one_part_and_10[i] for i in range(3)])
        self.play(road_new.animate.align_to(souren_t, UP))
        self.wait()
        ...
        road = road.align_to(souren_t, UP)
        road_length = MathTex(road_length_string).next_to(road, DOWN, buff=.7)
        souren_road = souren_road.align_to(souren_t, UP)
        arshak_road = arshak_road.align_to(souren_t, UP)
        arshak_road_brace = Brace(arshak_road, UP, buff=.08)
        souren_road_brace = Brace(souren_road, UP, buff=.08)
        arshak_road_time = MathTex(arshak_road_time_string).next_to(arshak_road, UP, buff=.5)
        souren_road_time = MathTex(souren_road_time_string).next_to(souren_road, UP, buff=.5)
        ...
        recap_souren_s = MathTex(souren_recap_s_string, color=GREEN_B).scale(0.7).align_to(souren_t, DL)
        recap_arshak_s = MathTex(arshak_recap_s_string, color=GREEN_B).scale(0.7).align_to(arshak_t, DL)
        recap_souren_v = MathTex(souren_recap_v_string, color=GREEN_B).scale(0.7).next_to(recap_souren_s, DL, buff=0.3).align_to(recap_souren_s, LEFT)
        recap_arshak_v = MathTex(arshak_recap_v_string, color=GREEN_B).scale(0.7).next_to(recap_arshak_s, DL, buff=0.3).align_to(recap_arshak_s, LEFT)
        recap_souren_t = MathTex(souren_recap_t_string, color=GREEN_B).scale(0.7).next_to(recap_souren_v, DL, buff=0.3).align_to(recap_souren_v, LEFT)
        recap_arshak_t = MathTex(arshak_recap_t_string, color=GREEN_B).scale(0.7).next_to(recap_arshak_v, DL, buff=0.3).align_to(recap_arshak_v, LEFT)
        self.play(
            AnimationGroup(
                Write(recap_souren_s),
                Write(recap_arshak_s),
                Write(recap_souren_v),
                Write(recap_arshak_v),
                Write(recap_souren_t),
                Write(recap_arshak_t),
                lag_ratio=1
            )
        )
