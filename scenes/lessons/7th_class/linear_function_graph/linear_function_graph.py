...
class LinearFunctionGraph(Scene):
    def construct(self):
        ...
        lin_function = Tex(linear_function_str, font_size=FONT_SIZE).shift(UP * 3.3)

        functions = VGroup(MathTex("y = kx + b", font_size=55).move_to(lin_function).shift(DOWN * .5),
                           MathTex("k = 2", font_size=45).move_to(lin_function).shift(DOWN + LEFT * 5.5),
                           MathTex("b = 3", font_size=45).move_to(lin_function).shift(DOWN * 1.5 + LEFT * 5.5),
                           MathTex("y = 2x + ", font_size=45).move_to(lin_function).shift(DOWN * .5 + LEFT * 5.2),
                           MathTex("y = 2x", font_size=45).shift(UP * 3.25 + RIGHT * 5.5),
                           MathTex("y = 3x", font_size=45).shift(UP * 3.6 + RIGHT * 4.5),
                           MathTex("-", font_size=45).move_to(lin_function).shift(LEFT * 4.5 + DOWN * .48)
                           )
        ...
        time_k = always_redraw(lambda: MathTex(str(round(k.get_value(), 2)),
                                               font_size=45).next_to(functions[3]).shift(LEFT * .2 + UP * .02))
        ...
        ).shift(LEFT * 5.3 + UP * 1.3).scale(0.7),
                       MathTable(
                           [["2"],
                            ["4"],
                            ["7"]],
                           include_outer_lines=True
                       ).shift(LEFT * 3.3 + UP * 1.3).scale(0.7),
                       MathTable(
                           [["0"],
                            ["0"],
                            ["3"]],
                           include_outer_lines=True
                       ).shift(LEFT * 2.25 + UP * 1.3).scale(0.7),
                       MathTable(
                           [["-2"],
                            ["-4"],
                            ["-1"]],
                           include_outer_lines=True
                       ).shift(LEFT * 1.05 + UP * 1.3).scale(0.7))
        ...
        points = VGroup(VGroup(
            ...
            Tex("(1, 2)", font_size=35, color=ORANGE).next_to(coordinate_axes.c2p(1, 2, 0)),
            ...
            VGroup(
                ...
                Tex("(1, 5)", font_size=35, color=GREEN).next_to(coordinate_axes.c2p(1, 5, 0)),
            ...
            VGroup(
                ...
                Tex("(2, 4)", font_size=35, color=ORANGE).next_to(coordinate_axes.c2p(2, 4, 0)),
            ...
            VGroup(
                ...
                Tex("(2, 7)", font_size=35, color=GREEN).next_to(coordinate_axes.c2p(2, 7, 0)),
            ...
            VGroup(
                ...
                Tex("(0, 0)", font_size=35, color=ORANGE).next_to(coordinate_axes.c2p(0, 0, 0)).shift(
                    DOWN * .4 + LEFT * .1),
            ...
            VGroup(
                ...
                Tex("(0, 3)", font_size=35, color=GREEN).next_to(coordinate_axes.c2p(0, 3, 0)).shift(LEFT * 1.5),
            ...
            VGroup(
                Dot(point=coordinate_axes.c2p(-2, -4, 0), color=ORANGE),
                Tex("(-2, -4)", font_size=35, color=ORANGE).next_to(coordinate_axes.c2p(-2, -4, 0)).shift(LEFT * 1.5),
                coordinate_axes.get_horizontal_line(coordinate_axes.c2p(-2, -4, 0), color=ORANGE),
                coordinate_axes.get_vertical_line(coordinate_axes.c2p(-2, -4, 0), color=ORANGE)
            ),
            VGroup(
                Dot(point=coordinate_axes.c2p(-2, -1, 0), color=GREEN),
                Tex("(-2, -1)", font_size=35, color=GREEN).next_to(coordinate_axes.c2p(-2, -1, 0)).shift(LEFT * 1.5),
        ...
        time = always_redraw(lambda: MathTex(str(round(t.get_value(), 2)),
                                             font_size=35).next_to(arrows[0]).shift(LEFT))
        ...
        self.play(coordinate_axes.animate.shift(RIGHT),
                  x_label.animate.shift(RIGHT * .7),
                  y_label.animate.shift(RIGHT),
                  functions[4].animate.shift(RIGHT * .85 + UP * .2),
        ...
        helper_numbers = VGroup(
            Tex(
                " $-$" + " $5$ ", font_size=35).to_edge(LEFT + UP).move_to(conclusions[3][0][4:]),
        ...
        final_points = VGroup(
            VGroup(Dot(point=coordinate_axes.c2p(0, 0, 0)),
                   Tex("(0, 0)", font_size=35).next_to(coordinate_axes.c2p(0, 0, 0)).shift(DOWN * .3 + LEFT * .1),
            ...
            VGroup(Dot(point=coordinate_axes.c2p(1, 3, 0)),
                   Tex("(1, 3)", font_size=35).next_to(coordinate_axes.c2p(1, 3, 0)),
            ...
            VGroup(Dot(point=coordinate_axes.c2p(0, -5, 0)),
                   Tex("(0, -5)", font_size=35).next_to(coordinate_axes.c2p(0, -5, 1)),
        ...
        self.play(conclusions[2][0][2:6].animate.scale(1.2))
        self.wait()
