from manim import WHITE, ORANGE
from manim import RIGHT, LEFT
from manim import Write, Create, Uncreate, Indicate, FadeOut, FadeIn
from manim import linear, ReplacementTransform
...
class MaserovKhndirScene(QarakusiScene):
    def PlayProblemCopying(
        ...
        self.play(ReplacementTransform(problem.drawing.first_segment.copy(),
    ...
    def PlayProblemProjecting(
        ...
        self.play(
            ReplacementTransform(problem.drawing.first_segment.copy(),
                                 problem.drawing.second_segment),
    ...
    def PlaySolution(
        ...
        self.play(ReplacementTransform(
            problem.drawing.brace.label.copy(),
            problem.solution.total_minus_extra[1:2])
        )
        self.wait(0.5)
        self.play(Write(problem.solution.total_minus_extra[2]))
        self.wait(0.5)
        self.play(ReplacementTransform(
            problem.drawing.extra_segment.text.copy(),
            problem.solution.total_minus_extra[3:4])
        )
        self.wait(0.5)
        ...
        self.play(indication(problem.drawing.first_segment,
                             amplitude=0.15,
                             time_width=2,
                             run_time=1,
                             color=problem.counting_color))
        ...
        self.play(indication(problem.drawing.second_segment,
                             amplitude=0.15,
                             time_width=2,
                             run_time=1,
                             color=problem.counting_color))
        ...
        self.wait(0.25)
        self.play(ReplacementTransform(problem.solution.count_one_part[0],
                                       problem.solution.divide_by_two[3]))
        self.wait(0.5)
        ...
        self.wait(0.5)
        self.play(ReplacementTransform(
            problem.solution.total_minus_extra[5:].copy(),
            problem.solution.divide_by_two[1:2])
        )
        self.wait(0.5)
        ...
        self.play(
            Indicate(problem.drawing.first_segment,
                     color=problem.counting_color),
            Indicate(problem.drawing.second_segment,
                     color=problem.counting_color),
            Indicate(problem.solution.divide_by_two[5],
                     color=problem.counting_color),
            run_time=1.5
        )
        self.wait(0.5)
        ...
        self.play(
            problem.drawing.extra_segment.animate.set_opacity(1).shift(0.5 * LEFT)  # noqa
        )
        self.wait(0.5)
        ...
        if problem.wanted == 'first':
            ...
            self.play(Write(problem.solution.equal_length_plus_extra,
                            run_time=3))
            self.wait(0.5)
            self.play(
                FadeIn(
                ...
                ReplacementTransform(
                    VGroup(problem.solution.second_segment_text,
                           problem.drawing.extra_segment.text),
