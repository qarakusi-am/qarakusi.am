...
class TaskWithParts(Scene):
    def construct(self):
        ...
        self.play(fade_in_out(participant_1_nontarget_2, participant_1_nontarget))
        self.wait()
        self.play(
        ...
        self.play(
            FadeIn(participant_3_nontarget[1])
        )
        self.wait(WAIT_TIME)
        self.play(
        ...
        self.play(
            ...
            fade_in_out(participant_3[1].update_label_pos(), VGroup(
                    participant_3_nontarget[2].update_label_pos(),
                    participant_3_nontarget[1].update_label_pos()
                ))
        )
        self.play(Indicate(participant_3[1].label))
        self.play(
            fade_in_out(participant_3_nontarget, participant_3),
            fade_in_out(VGroup(
                    participant_3_nontarget[2].update_label_pos(),
                    participant_3_nontarget[1].update_label_pos()
        ...
        self.play(
            participant_3_nontarget[1:].animate.align_to(participant_1, RIGHT),
        ...
        self.wait(WAIT_TIME)
        self.play(Write(formula_5), participant_3_nontarget[1:].animate.next_to(participant_3[0], RIGHT, buff = 0))
        segment_3 = from_player_segment(participant_3).set_color(COLOR_PALETTE[4])
        segment_3.set_label(MathTex(r"44000").scale(0.8))
        self.play(
            fade_in_out(segment_3, VGroup(participant_3_nontarget, participant_3_nontarget[1].label, participant_3_nontarget[2].label, participant_3[0].label)),
