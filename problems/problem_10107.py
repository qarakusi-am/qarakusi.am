...
class PartScene(Scene):
    def construct(self):
        ...
        self.play(
            Create(daughter),
            FadeIn(
                Tex("Անի", tex_template=ARMTEX).scale(0.5).next_to(daughter, DOWN),
        ...
        self.play(
            Create(mother),
            FadeIn(
                Tex("Մայրիկ", tex_template=ARMTEX).scale(0.5).next_to(mother, DOWN),
                rate_func = rate_functions.there_and_back_with_pause
            )
        )
        self.wait(0.8)
        ...
        self.play(
            ...
            FadeIn(
                Tex("$1$ տարի անց", tex_template=ARMTEX).scale(1.5).to_edge(DR).set_color(RED),
                rate_func = rate_functions.there_and_back_with_pause
            ),
            run_time = 2
        )
        ...
        self.play(
            ...
            Flash(mother_segment.get_edge_center(RIGHT), run_time=0.7),
            FadeIn(
                Tex("ևս $1$ տարի անց", tex_template=ARMTEX).scale(1.5).to_edge(DR).set_color(RED),
                rate_func = rate_functions.there_and_back_with_pause
            ),
            run_time = 2
        )
        ...
        self.play(
            ...
            FadeIn(
                Tex("Այժմ", tex_template=ARMTEX).scale(1.5).to_edge(DR).set_color(RED),
                rate_func = rate_functions.there_and_back_with_pause
            ),
            run_time = 3
        )
        ...
        self.play(
            ...
            Flash(mother_segment.get_edge_center(RIGHT), run_time=0.7),
            FadeIn(
                Tex("$2$ տարի անց", tex_template=ARMTEX).scale(1.5).to_edge(DR).set_color(RED),
                rate_func = rate_functions.there_and_back_with_pause
            ),
            run_time = 1
        )
        ...
        self.play(
            ...
            FadeIn(
                Tex("Մի քանի տարի հետո", tex_template=ARMTEX).scale(1.3).to_edge(DR).set_color(RED),
                rate_func = rate_functions.there_and_back_with_pause
            ),
            run_time = 7
        )
        ...
        self.wait()
        self.play(ApplyWave(daughter_segment))
        self.wait()
        ...
        self.play(
            ...
            Write(Tex("տարի անց", tex_template=ARMTEX).next_to(formula_0[1], RIGHT).set_color(RED))
        )
        self.wait(3)
    ...
    def set_up(self, add = False):
        ...
        daughter = self.daughter_svg = SVGMobject('../SVGs/dustr.svg')
        daughter.scale(1.4)
        mother = self.mother_svg = SVGMobject('../SVGs/mayr.svg')
        mother.scale(1.9)
